...
- Note that in the *Instructions* we use the Instruction message from the Bing Copilot examples which helps to give our agent a personality.
...
Please list the files you have access to
